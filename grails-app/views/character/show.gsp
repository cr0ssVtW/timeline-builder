...
<html>
    ...
    <body>
        ...
        <div id="show-character" class="content scaffold-show" role="main">
            ...
            <f:display bean="character" />
            <g:form resource="${this.character}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.character}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
